...
class RearrangeMethodsProcessor {
    ...
    RearrangeMethodsProcessor(
        PsiJavaFile javaFile, Document document, PsiDocumentManager documentManager) {
    ...
    private void rearrangeClassSourceCode(
        Document document, PsiClass psiClass, PsiDocumentManager documentManager) {
