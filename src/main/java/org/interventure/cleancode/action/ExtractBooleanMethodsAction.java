 ...
 */
public class ExtractBooleanMethodsAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        if (!FileDocumentManager.getInstance().requestWriting(document, project)) {
            Messages.showMessageDialog(project, PsiBundle
                    .message("cannot.modify.a.read.only.file", javaFile.getName()),
